...
while True:
    ...
    logger.info(f"Total read register success: {success_register_count:}")
    logger.info(f"Total read register failures: {failure_register_count:}")
    logger.info(f"Total success read holding registers time: {total_success_time_reg:.6f} seconds")
    logger.info(f"Total failure read holding registers time: {total_failure_time_reg:.6f} seconds")
